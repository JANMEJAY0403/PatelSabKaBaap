...
class Karatsuba
{
    String multiplication(String a,String b)
    {
        ...
        int string1=a.length();
        
        int string2=b.length();
        int N=max(string1,string2);
        if(N==1)
        ...
        String br=b.substring(N/2,N);
         ...
         String p1=multiplication(al,bl); //al*bl
         String p2=multiplication(ar,br); //ar*br
         String k1=digitadder(al,ar); //(al+ar)
         String k2=digitadder(bl,br); //(bl+br)
         String k3=multiplication(k1,k2); //(al+ar)*(bl+br)
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Evater value of a: ");
        String a=sc.nextLine();
        System.out.println("Evater value of b: ");
        String b=sc.nextLine();
        String mul= ob.multiplication(a,b);
